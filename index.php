...
<form class="form-signin" method="post" action="aksi_login.php">
  ...
  <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Pasword" required>
  ...
  <p><button class="btn btn-lg btn-primary btn-block" type="submit">Masuk</button></p>
  <p><button class="btn btn-lg btn-primary btn-block" type="button"><a href="register.php" style="color:white">Daftar</button></p>
